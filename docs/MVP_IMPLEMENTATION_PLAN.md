...
| E06-T06 — Hero board and overlay | Mobile progression interaction | implement XP/Level/attributes, Class/Vocation/Profession ancestry, point spending, prerequisites, previews, locked reasons, equipment thresholds, undo-before-confirm behavior, and concise HeroSheet summary |
